...
const App = (props) => {
  ...
  return (
    <div className="page-container">
      {showNewWorkout && <CreateWorkoutModal logged_in={loggedIn} current_user={props.current_user} toggle={toggleShowNewWorkout} createWorkout={createWorkout} />}
      <BrowserRouter>
        <Header logged_in={loggedIn} toggleNewWorkout={toggleShowNewWorkout} />
        <Routes>
